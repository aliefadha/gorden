...
export function FloatingInstagram() {
  ...
  const handleOptionClick = () => {
    window.open("https://www.instagram.com/amagriya_gorden", "_blank");
    setIsOpen(false);
  };
    ...
    <>
      ...
      {isOpen && (
        ...
        >
          ...
          >
            <p className="text-sm font-semibold text-gray-800">Ikuti Kami</p>
          </button>
        </div>
      )}
      ...
      <button
        ...
        aria-label={isOpen ? "Close menu" : "Open Instagram menu"}
